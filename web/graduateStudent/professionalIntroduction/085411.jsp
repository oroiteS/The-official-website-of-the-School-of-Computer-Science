...
*CreateTime: 2024/11/25-0:44
*Description: 专业介绍·085411大数据技术与工程专业介绍（工程类硕士）
*@author SYN
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>
<head>
    <title>085411大数据技术与工程专业介绍（工程类硕士）</title>
                        ...
                        <div id="newsContent">
                            <div class="wp_articleContent">
                                <p class="p_text_indent_2" style="font-size:20px;">
                                    大数据技术与工程学科是我校重点发展的学科之一，学科根据能源互联网的发展需求并结合我校的电力特色，
                                    本专业聚焦“电力能源”行业对大数据技术与工程人才的需求特点，与企业合作培养适合国家信息发展战略的具有较强的
                                    实践创新能力、跨文化交流能力和跨领域研究能力的高素质复合型人才。近年来，本学科得到了上海市重点学科、
                                    上海市教委重点学科的资助，针对电力行业的信息化、智能化建设需求，开展了大量的科学研究和应用实践，
                                    在数据建模与应用优化、新能源接入与数据安全、电力预测与数据可视化、电网规划与数据挖掘、电力大数据处理及应用、
                                    数据科学与知识工程等研究领域具有重要的影响。
                                </p>
                                <p class="p_text_indent_2" style="font-size:20px;">
                                    学科拥有一支以中青年教师为骨干、学术思想活跃的教师队伍，已经积累了丰厚的研究基础，具有较为合理的学术梯队
                                    和良好的科研发展态势。目前已有研究生指导教师33人，其中教授10人，副教授16人，95%以上具有博士学位。
