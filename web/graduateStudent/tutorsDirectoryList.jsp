                ...
                <div class="col-md-10" style="height: 288px">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="tutorsDirectory.jsp" style="color: black;text-decoration: none;">
                                计算机科学与技术学院--研究生导师名录
                            </a>
                        </span>
                        <span style="float:right;padding-right:0;color:gray;font-size: 14px;">2016-01-05</span>
                        <br>
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;校内导师：081200计算机科学与技术专业硕士生导师：毕忠勤
                            &nbsp;&nbsp; &nbsp;&nbsp;杜海舟&nbsp; &nbsp; &nbsp;田秀霞&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            王勇&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;魏为民&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;温蜜&nbsp; &nbsp; &nbsp; &nbsp; 李晋国&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;刘大明&nbsp;&nbsp;
                            &nbsp;&nbsp;王亮亮&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;王真栗风永&nbsp;...
