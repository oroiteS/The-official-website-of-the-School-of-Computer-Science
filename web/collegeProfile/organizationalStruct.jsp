<%--
*ClassName: organizationalStruct
*Package: collegeProfile
*CreateTime: 2024/11/24-13:39
*Description: 组织结构
*@author SYN
--%>
                            ...
                            <div class="wp_articleContent">
                                <p style="text-align:center">
                                    <img data-layer="photo"
                                         src="${pageContext.request.contextPath}/img/organizationStruct.jpg"
                                         alt="组织结构">
                                </p>
                                <table class="pure-table" style="width: 80%;">
                                    ...
                                    <tr>
                                        <td style="text-align:right;width: 20%;">
                                            <a target="_self">&nbsp;党政办主任</a>
                                        </td>
                                        <td style="width: 20%;">
                                            <a target="_self">▸&nbsp;诸葛琼</a>
                                        </td>
                                        <td style="width: 20%;">
                                            <br>
                                        </td>
                                        <td style="text-align:right;width: 20%;">
                                            <a target="_self">&nbsp;组织员</a>
                                        </td>
                                        <td style="width: 20%;">
                                            <a target="_self">▸&nbsp;聂坤</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="text-align:right">
                                            <a target="_self">&nbsp;学院教务</a>
                                        </td>
                                        <td>
                                            <a target="_self">▸&nbsp;毛志华</a>
                                        </td>
                                        <td style="width: 20%;">
                                            <br>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="text-align:right">
                                            <a target="_self" style="text-align:center">&nbsp;团委书记、辅导员 </a>
                                        </td>
                                        <td><a target="_self">▸&nbsp;卢珍</a></td>
                                        <td style="width: 20%;"><br></td>
                                        <td style="text-align:right">
                                            <a target="_self" style="text-align:center">&nbsp;辅导员</a>
                                        </td>
                                        <td><a target="_self">▸&nbsp;任祥宝</a></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:right"><a target="_self" style="text-align:center">&nbsp;辅导员</a>
                                        </td>
                                        <td><a target="_self">▸&nbsp;马安奕</a></td>
                                        <td style="width: 20%;"><br></td>
                                        <td style="text-align:right"><a target="_self">&nbsp;辅导员</a></td>
                                        <td><a target="_self">▸&nbsp;周远航</a></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:right"><a target="_self">&nbsp;辅导员</a></td>
                                        <td><a target="_self">▸&nbsp;孙倩倩</a></td>
                                        <td style="width: 20%;"><br></td>
                                        <td style="text-align:right"><a target="_self">&nbsp;辅导员</a></td>
                                        <td><a target="_self">▸&nbsp;宋钰</a></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:right"><a target="_self">&nbsp;辅导员</a></td>
                                        <td><a target="_self">▸&nbsp;张潇月</a></td>
                                        <td style="width: 20%;"><br></td>
