<%--
*ClassName: collegeProfileList
*Package: collegeProfile
*CreateTime: 2024/11/24-13:22
*Description: 学院简介列表
*@author SYN
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2">
                    <ul>
                        <li>
                            <a class="column-name" title="学院简介" href="collegeProfileList.jsp">
                                <i class="bi"></i>
                                <span>学院简介</span>
                            </a>
                        </li>
                        <li>
                            <a class="column-name" title="学院领导" href="collegeLeaderList.jsp">
                                <i class="bi"></i>
                                <span>学院领导</span>
                            </a>
                        </li>
                        <li>
                            <a  class="column-name" title="组织机构" href="organizationalStructList.jsp">
                                <i class="bi"></i>
                                <span>组织机构</span>
                            </a>
                        </li>
                ...
                <div class="col-md-10">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="collegeProfile.jsp" style="color: black;text-decoration: none;">
                                计算机科学与技术学院简介
                            </a>
                        </span>
                        <span style="float:right;padding-right:0;color:gray;font-size: 14px;">2024-01-01</span>
                        <br>
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计算机科学与技术学院现设有计算机科学与技术（含卓越班）、
                            软件工程、信息安全、数据科学与大数据技术等本科专业，拥有计算机科学与技术一级学科硕士学位点和计算机技术、
                            人工智能、大数据技术与工程等三个方向的专业型硕士学位点；拥有“电力企业信息化与决策支持”上海市重点学科
                            （参与）、“智能电网技术与工程”上海市教委重点学科；“计算机科学与技术”上海市人才高地、
                            计算机科学与技术(电力企业信息化)国家“卓越工程师教...
                        </p>
                    </div>
                </div>
            </div>
