<%--
*ClassName: collegeLeaderList
*Package: collegeProfile
*CreateTime: 2024/11/24-13:38
*Description: 学院领导列表
*@author SYN
--%>
                ...
                <div class="col-md-10">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            <i style="font-size:14px;color:green">&nbsp;&nbsp;</i>
                            <a href="collegeLeader.jsp" style="color: black;text-decoration:none;">
                                计算机科学与技术学院学院--领导介绍
                            </a>
                        </span>
                        ...
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学院党委领导&nbsp;书记▸&nbsp;魏建华&nbsp;副书记▸&nbsp;温蜜
                            &nbsp; 副书记▸&nbsp;齐永晓学院行政领导&nbsp;院长▸&nbsp;温蜜&nbsp;常务副院长▸&nbsp;张传林
                            &nbsp; 副院长▸&nbsp;李晋国
                        </p>
                    </div>
                </div>
