...
*CreateTime: 2024/12/14-16:41
*Description: 资源下载·教务相关
*@author SYN
*@Date 2024/12/14
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="height: 288px">
                    ...
                    <%
                        // 获取资源列表，默认显示学生相关
                        List<Object[]> resourceList = resourceDao.getResourcesByType("teaching");
                        // 遍历资源列表
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="./resourceDownload.jsp?id=<%= hash.hash.getHash(title+publishTime+"teaching")%>&type=<%= "teaching"%>"
