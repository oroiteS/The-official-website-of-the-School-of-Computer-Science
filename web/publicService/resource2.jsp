...
*CreateTime: 2024/12/14-16:42
*Description: 资源下载·科研相关
*@author SYN
*@Date 2024/12/14
--%>
                    ...
                    <ul>
                        ...
                        <%
                            if("administrator".equals(session.getAttribute("identity"))) {
                                out.println("<li> <a href=\""+request.getContextPath()+"/publicService/resourceManagement.jsp\" target=\"_self\">资源管理</a></li>");
                            }
                        %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2">
                    <ul>
                        <li>
                            <a class="column-name" title="学生相关" href="./resource.jsp">
                                <i class="bi"></i>
                                <span>学生相关</span>
                            </a>
                        </li>
                        <li>
                            <a class="column-name" title="教务相关" href="./resource1.jsp">
                                <i class="bi"></i>
                                <span>教务相关</span>
                            </a>
                        </li>
                        <li>
                            <a class="column-name" title="科研相关" href="./resource2.jsp">
                                <i class="bi"></i>
                                <span>科研相关</span>
                            </a>
                        </li>
                        <li>
                            <a class="column-name" title="基础课程" href="resource3.jsp">
                                <i class="bi"></i>
                                <span>基础课程</span>
                            </a>
                        </li>
                ...
                <div class="col-md-10" style="height: 288px">
                    <br>
                    <%
                        // 获取资源列表，默认显示学生相关
                        List<Object[]> resourceList = resourceDao.getResourcesByType("research");
                        // 遍历资源列表
                        for(Object[] resource : resourceList) {
                            String title = resource[0].toString();
                            String publishTime =resource[1].toString();
                    %>
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            <i style="font-size:14px;color:green" class="bi bi-chevron-right">&nbsp;&nbsp;</i>
                            <a href="./resourceDownload.jsp?id=<%= hash.hash.getHash(title+publishTime+"research")%>&type=<%= "research"%>" style="color: black;text-decoration: none;">
                                <%= title %>
                            </a>
                        </span>
                        ...
                        <br>
                        <p style="margin-top:14px;color:gray;font-size:13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    </div>
                    <%
                        }
                    %>
