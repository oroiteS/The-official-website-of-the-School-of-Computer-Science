        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="height: 288px">
                    ...
                    <%
                        // 获取资源列表，默认显示学生相关
                        List<Object[]> resourceList = resourceDao.getResourcesByType("basic");
                        // 遍历资源列表
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="./resourceDownload.jsp?id=<%= hash.hash.getHash(title+publishTime+"basic")%>&type=<%= "basic"%>"
