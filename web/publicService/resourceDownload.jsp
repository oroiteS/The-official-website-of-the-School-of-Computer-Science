...
*ClassName: resourceDeload
*Package: 
*CreateTime: 2024/12/15-1:38
*Description: 资源具体展示类
*@author SYN
--%>
...
<head>
    ...
    %>
    <jsp:useBean id="currentResource" class="publicService.resource">
        <jsp:setProperty name="currentResource" property="id" value="<%=id%>"/>
    </jsp:useBean>
    <title><jsp:getProperty name="currentResource" property="title" /></title>
                ...
                <div class="col-lg-12">
                    <div style="margin-top:30px">
                        <h4 style="margin-bottom: 10px;text-align: center;font-size: 22px;font-family: '微软雅黑',serif;">
                            <jsp:getProperty name="currentResource" property="title" />
                        </h4>
                        <h4 style="margin-bottom: 10px;text-align: center;font-size:14px;font-family: '微软雅黑',serif;color:darkgray">
                            发布日期：<jsp:getProperty name="currentResource" property="publishTime" />
                        </h4>
                        <div>
                            <%
                                List<Object[]> links = currentResource.getLinks();
                            ...
                            <p>
                                ...
                                <a href="<%= currentResource.getResourcePath(type, path) + "/" + filePath %>"
