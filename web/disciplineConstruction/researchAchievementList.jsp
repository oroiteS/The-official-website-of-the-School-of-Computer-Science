<%--
*ClassName: researchArchivementList
*Package: disciplineConstruction
*CreateTime: 2024/11/24-13:45
*Description: 科研成果
*@author SYN
--%>
                ...
                <div class="col-md-10">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="researchAchievement.jsp" style="color: black;text-decoration: none;">计算机科学与技术学院科研项目</a>
                        </span>
                        ...
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学院目前已承担100余项国家自然科学基金项目、教育部科技项目、上海
                            市科委重点项目、上海市科委创新行动计划及各类人才计划等纵向项目；另已承担各类电力及计算机互联网企业委托科
                            研项目100余项。国家自然科学基金[1]国家自然科学基金（联合基金）：基于内生安全的工业互联网主动安全防护机制
                            研究,&nbsp;2024.01.01-2027.12.31，255万元；[2]&nbsp;国家自然科学基金委（联合基金）：基于深度学习
                            的高通量网络攻击智能检测与场景构...</p>
                    </div>
                </div>
            </div>
