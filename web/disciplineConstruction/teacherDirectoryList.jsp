<%--
*ClassName: teacherDictory
*Package: disciplineConstruction
*CreateTime: 2024/11/24-13:44
*Description: 教师名录
*@author SYN
--%>
                ...
                <div class="col-md-10">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="teacherDirectory.jsp" style="color: black;text-decoration: none;">
                                计算机科学与技术学院教师名录
                            </a>
                        </span>
                        ...
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;教授▸&nbsp;毕忠勤▸&nbsp;李海明▸&nbsp;田秀霞▸&nbsp;王勇▸&nbsp;
                            温蜜▸&nbsp;张传林▸&nbsp;张挺▸&nbsp;范自柱▸&nbsp;徐菲菲▸&nbsp;栗风永副教授▸&nbsp;曹渝昆▸&nbsp;陈仕兵▸
                            &nbsp;杜海舟▸&nbsp;李红娇▸&nbsp;李晋国▸&nbsp;李婧▸&nbsp;刘大明▸&nbsp;刘辉▸&nbsp;卢芳芳▸&nbsp;彭源▸
                            &nbsp;齐俊▸&nbsp;王剑云▸&nbsp;王亮亮▸&nbsp;王真▸&nbsp;魏建华▸&nbsp;魏为民▸&nbsp;徐曼▸&nbsp;薛梅▸
                            &nbsp;叶文珺▸&nbsp;殷脂▸&nbsp;张安勤▸&nbsp;张...
                        </p>
                    </div>
                </div>
