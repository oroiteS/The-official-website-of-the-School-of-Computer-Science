<%--
*ClassName: teacherProfileList
*Package: disciplineConstruction
*CreateTime: 2024/11/24-13:43
*Description: 师资概况
*@author SYN
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2">
                    <ul>
                        <li>
                            <a class="column-name" title="师资概况" href="teacherProfileList.jsp">
                                <i class="bi"></i>
                                <span>师资概况</span>
                            </a>
                        </li>
                        <li>
                            <a class="column-name" title="教师名录" href="teacherDirectoryList.jsp">
                                <i class="bi"></i>
                                <span>教师名录</span>
                            </a>
                        </li>
                        <li>
                            <a  class="column-name" title="科研成果" href="researchAchievementList.jsp">
                                <i class="bi"></i>
                                <span>科研成果</span>
                            </a>
                        </li>
                ...
                <div class="col-md-10">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="teacherProfile.jsp" style="color: black;text-decoration: none;">
                                计算机科学与技术学院师资概况
                            </a>
                        </span>
                        <span style="float:right;padding-right:0;color:gray;font-size: 14px;">2024-04-18</span>
                        <br>
                        <p style="margin-top:14px;color:gray;font-size:13px">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计算机科学与技术学院拥有一支以中青年教师为骨干、结构合理、
                            学术思想活跃、综合素质高的教师队伍。教职工62名，其中教授10名、副教授25名，具有博士、硕士学位的教师有60余人
                            。 从教师的年龄分布情况看，50岁以下教师占教师总数的77%，其中多名教师入选上海市浦江人才计划、
                            上海市青年科技启明星计划、上海市晨光计划等人才计划。从教师的学缘结构看，我院专任教师主要来自于清华大学、
                            上海交通大学、复旦大学、华东师范大...
                        </p>
                    </div>
                </div>
