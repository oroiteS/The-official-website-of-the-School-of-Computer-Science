<%--
*ClassName: teachingAchievement
*Package: undergraduateTeaching
*CreateTime: 2024/11/25-0:28
*Description: 教学成果
*@author SYN
--%>
                ...
                <div class="col-lg-12">
                    <div style="margin-top:30px">
                        <h4 style="margin-bottom: 10px;text-align: center;font-size: 22px;font-family: '微软雅黑',serif;">
                            计算机科学与技术学院主持建设上海市重点课程和一流课程清单(2006-2023年度)
                        </h4>
                        ...
                        <div id="newsContent">
                            <div class="wp_articleContent">
                                <p>
                                    <img data-layer="photo" src="${pageContext.request.contextPath}/img/teachingAchievement.png"
                                         style="float:none;width: 100%;"
                                         alt="计算机科学与技术学院主持建设上海市重点课程和一流课程清单(2006-2023年度)"
                                    >
                                </p>
                                <p>
                                    <br>
