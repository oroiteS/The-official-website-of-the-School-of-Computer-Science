<%--
*ClassName: teacheringAchievementList
                ...
                <div class="col-md-10" style="height: 288px">
                    ...
                    <div style="margin:5px 10px 5px 0;">
                        <span style="font-size: 16px; font-weight: bold;">
                            ...
                            <a href="teachingAchievement.jsp" style="color: black;text-decoration: none;">
                                计算机科学与技术学院主持建设上海市重点课程和一流课程清单(200...
                            </a>
                        </span>
                        <span style="float:right;padding-right:0;color:gray;font-size: 14px;">2024-01-07</span>
                        <br>
